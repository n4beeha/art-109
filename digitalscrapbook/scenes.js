...
function main()  {
  ...
  this.enter = function()
  {
    ...
    btnevent3 = checkButtonPress(bfashowbutton,494,410,349, 211, color(220,100,100),color(100),color(250));  
    if (btnevent3) { // help
      btnevent3 = false;
    ...
    btnevent6 = checkButtonPress(makerfairebutton,710,160,372, 150, color(220,100,100),color(100),color(250));  
    if (btnevent6) { // help
      btnevent6 = false;
      this.sceneManager.showScene( makerfaire );
    }

    btnevent7 = checkButtonPress(mainbutton,65,13,47,47,color(220,100,100),color(100),color(250));  
    if (btnevent7) { // main
      btnevent7 = false;
      this.sceneManager.showScene( main );
    }
